...
public class VehicleController {
    ...
    public ResponseEntity<TransportSet> createTransportSet(@RequestBody CreateTransportSetRequest request) {
        log.info("Creating transport set: transporter={}, cargo={}",
                request.getTransporterId(), request.getCargoId());
        ...
        log.info("Transport set created with ID: {} (standalone: {})",
                saved.getId(), cargo.getCanDriveAlone());
